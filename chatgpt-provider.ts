...
const MODEL_MAP: Record<string, string> = {
  ...
  // Current slugs, read off /backend-api/models (checked Sep 2026). The older
  // gpt-5.0 - 5.4 entries above this block are gone from the account and are
  // kept only so existing configs keep resolving to something.
  ...
  "chatgpt/gpt-5.6":           "gpt-5-6",
  "chatgpt/gpt-5.6-instant":   "gpt-5-6-instant",
  "chatgpt/gpt-5.6-thinking":  "gpt-5-6-thinking",
  "chatgpt/gpt-5.6-mini":      "gpt-5-6-mini",
  "chatgpt/gpt-5.6-pro":       "gpt-5-6-pro",
  "chatgpt/gpt-6-pro":         "gpt-6-pro",
  // The "-wm" slugs (gpt-5.6-sol-wm, gpt-6-astra-wm, ...) also appear in
  // /backend-api/models but answer with an empty body over this path, so they
...
export function getChatGPTModelObjects(): any[] {
  const models = [
    ...
    // Current GPT-5.5 / 5.6 / 6 family
    { id: "chatgpt/gpt-5.5", context: 1050000 },
    { id: "chatgpt/gpt-5.5-instant", context: 1050000 },
    { id: "chatgpt/gpt-5.5-thinking", context: 1050000 },
    { id: "chatgpt/gpt-5.5-mini", context: 1050000 },
    { id: "chatgpt/gpt-5.5-pro", context: 1050000 },
    { id: "chatgpt/gpt-5.6", context: 1050000 },
    { id: "chatgpt/gpt-5.6-instant", context: 1050000 },
    { id: "chatgpt/gpt-5.6-thinking", context: 1050000 },
    { id: "chatgpt/gpt-5.6-mini", context: 1050000 },
    { id: "chatgpt/gpt-5.6-pro", context: 1050000 },
    { id: "chatgpt/gpt-6-pro", context: 1050000 },
